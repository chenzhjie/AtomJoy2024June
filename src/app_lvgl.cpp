...
static void screen_btn_1_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		if (!long_press_flag) {
			beep();
			ui_load_scr_animation(&guider_ui, &guider_ui.screen_running, guider_ui.screen_running_del, &guider_ui.screen_del, setup_scr_screen_running, LV_SCR_LOAD_ANIM_FADE_ON, 0, 0, false, true);			
		}
		long_press_flag = 0;
		break;
	}
...
static void screen_running_btn_1_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		if (AltMode == ALT_CONTROL_MODE && fly_mode == PARKING_MODE && alt_flag == 0 && !fly_status)
		{
			fly_status = 1;
			auto_up_down_status = 1;
			beep();	
		}
		if (AltMode == ALT_CONTROL_MODE && fly_mode == FLIGHT_MODE && alt_flag == 1 && fly_status)
		{
			fly_status = 0;
			auto_up_down_status = 1;
			beep();	
	...
	// 	beep();
	// 	long_press_flag = 1;
	// 	ui_load_scr_animation(&guider_ui, &guider_ui.screen, guider_ui.screen_del, &guider_ui.screen_running_del, setup_scr_screen, LV_SCR_LOAD_ANIM_FADE_ON, 0, 0, false, true);
	// 	break;
	// }	
	default:
		break;
...
void setup_scr_screen_running(lv_ui *ui)
{
	...
	lv_obj_set_style_text_font(ui->screen_running_label_2, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_running_label_1, &lv_font_montserratMedium_12, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_running_label_3, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_running_label_6, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_running_label_4, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_running_label_7, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_running_label_5, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_running_label_8, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
...
void screen_running_timer_cb(lv_timer_t *t)
{
	if (is_fly_flag) {
		...
		if (AltMode == ALT_CONTROL_MODE && fly_mode == PARKING_MODE) {
			lv_obj_set_style_bg_color(guider_ui.screen_running_btn_1, lv_color_hex(0x33cc99), LV_PART_MAIN|LV_STATE_DEFAULT);
			lv_obj_set_style_text_color(guider_ui.screen_running_btn_1, lv_color_hex(0x0), LV_PART_MAIN|LV_STATE_DEFAULT);
			...
			lv_obj_set_style_bg_color(guider_ui.screen_running_btn_1, lv_color_hex(0x8D0098), LV_PART_MAIN|LV_STATE_DEFAULT);
			lv_obj_set_style_text_color(guider_ui.screen_running_btn_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
			...
			lv_obj_set_style_bg_color(guider_ui.screen_running_btn_1, lv_color_hex(0xC1001D), LV_PART_MAIN|LV_STATE_DEFAULT);
			lv_obj_set_style_text_color(guider_ui.screen_running_btn_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
			...
			lv_obj_set_style_bg_color(guider_ui.screen_running_btn_1, lv_color_hex(0x007917), LV_PART_MAIN|LV_STATE_DEFAULT);
			lv_obj_set_style_text_color(guider_ui.screen_running_btn_1, lv_color_hex(0x0), LV_PART_MAIN|LV_STATE_DEFAULT);
		...
		guider_ui.screen_running_label_1, guider_ui.screen_running_label_2, pitch_value, pitch_rotation, roll_value);	
	}
	else {
